...
export function ContactFormGridWithDetails() {
  ...
  const socials = [
    {
      ...
      icon: (
        <IconBrandX
          className="h-5 w-5 text-neutral-600 dark:text-neutral-400 hover:text-black" />
      ),
    },
    {
      title: "github",
  ...
  return (
    <div
      className="bg-gray-50 dark:bg-neutral-900 w-full flex items-center justify-center">
      <div
        className="flex relative px-4 z-20 items-center w-full justify-center py-10">
        <div
          className="mx-auto w-full max-w-lg bg-white dark:bg-neutral-950 px-4 md:px-10 py-8 shadow-input rounded-3xl">
          <div>
            <h1
