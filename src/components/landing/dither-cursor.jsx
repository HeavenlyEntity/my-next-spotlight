...
/* Ported verbatim from the "minimal" landing template
   (components/dither-cursor.tsx). A ping-pong FBO simulation advects a
   cursor brush through curl noise, then a Bayer-8 dither pass paints it in
   one flat color. Default color moved to the amw accent. */
...
function SceneInternal({
  ...
  const ditherMaterialRef = useRef(null)
