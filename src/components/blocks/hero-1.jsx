...
export function Hero1() {
  return (
    <section
      className="w-full flex items-start lg:items-center py-12 px-4 sm:px-6 lg:px-8 bg-white dark:bg-neutral-950">
        ...
        <div
          ...
          <div className="flex flex-col space-y-6 sm:space-y-8">
            ...
            <motion.div
              ...
              <span
                className="inline-flex items-center px-3 py-1 rounded-full bg-black dark:bg-white text-white dark:text-black text-xs sm:text-sm font-medium">
                New
              </span>
              <span
                className="text-sm sm:text-base text-neutral-900 dark:text-neutral-100 mr-2">
            ...
            <motion.div
              ...
              <div className="flex -space-x-2">
                <div
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-black dark:bg-white border-4 border-white dark:border-neutral-950 flex items-center justify-center text-white dark:text-black text-xs sm:text-sm font-semibold">
                  JD
                </div>
                <div
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-black dark:bg-white border-4 border-white dark:border-neutral-950 flex items-center justify-center text-white dark:text-black text-xs sm:text-sm font-semibold">
          ...
          <motion.div
            ...
            <div
              className="relative w-full h-full min-h-[250px] sm:min-h-[500px] rounded-4xl bg-neutral-100 dark:bg-neutral-900 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors overflow-hidden">
              <img
              ...
              <div className="absolute bottom-0 right-0 flex flex-col items-end">
                ...
                <div className="relative">
                  <div
                    className="w-24 h-24 bg-white dark:bg-neutral-950 rounded-tl-4xl pl-4 pt-4">
                    <button
