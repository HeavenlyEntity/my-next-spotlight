/* Kingdom Kode mark, inlined from the brand kit's Transparent Logo
   Icon.svg with fill=currentColor so it follows the theme's text color. */

export default function KingdomKodeMark(props) {
  return (
    <svg
      viewBox="0 0 301 301"
      fill="currentColor"
