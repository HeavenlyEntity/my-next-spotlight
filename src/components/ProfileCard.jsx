        ...
        <section
          ...
          <div
            ...
            <div
              ...
              {showUserInfo && (
                <div
                  ...
                  <button
                    className="border border-white/10 rounded-lg px-2 py-1 text-xs font-semibold text-white/90 cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:border-white/40 hover:-translate-y-px"
            ...
            <div
              ...
              <div
                className="font-inter font-extrabold leading-relaxed w-full absolute flex flex-col"
