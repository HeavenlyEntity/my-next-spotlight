...
const ProfileCardComponent = ({
  ...
  behindGlowSize,
  className = '',
  cardHeightMobile = '80svh',
  cardMaxHeightMobile = '650px',
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--card-height-mobile': cardHeightMobile,
      '--card-max-height-mobile': cardMaxHeightMobile,
      '--card-height-desktop': cardHeightDesktop,
      '--card-max-height-desktop': cardMaxHeightDesktop,
    }),
    [
      iconUrl,
      grainUrl,
  ...
  return (
    ...
    >
      ...
      <div ref={shellRef} className="group relative z-[1]">
        <section
          className="backface-hidden relative grid h-[var(--card-height-mobile)] max-h-[var(--card-max-height-mobile)] overflow-hidden sm:h-[var(--card-height-desktop)] sm:max-h-[var(--card-max-height-desktop)]"
          style={{
            aspectRatio: '0.58',
            borderRadius: cardRadius,
        ...
        >
          ...
          >
            ...
            >
              <img
                className="backface-hidden absolute left-1/2 bottom-[-1px] w-full transition-transform duration-[120ms] ease-out will-change-transform"
                src={avatarUrl}
              ...
              {showUserInfo && (
                ...
                >
                  ...
                  <button
                    className="cursor-pointer rounded-lg border border-white/10 px-2 py-1 text-xs font-semibold text-white/90 backdrop-blur-[10px] transition-all duration-200 ease-out hover:-translate-y-px hover:border-white/40"
